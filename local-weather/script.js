$(function(){
    ...
    function getCurrentWeather(pos) {
        $.getJSON("https://api.darksky.net/forecast/75a4c6b840bd5cd4c5d545326a12072c/"+pos.latitude+","+pos.longitude+"?units=si&callback=?", function(data){
            ...
            // for example (uncomment line below this one): 
            // iconName = "rain";
            ...
            $.getJSON("https://maps.googleapis.com/maps/api/geocode/json?latlng="+ pos.latitude+","+pos.longitude, function(gglData){
                place = gglData.results[0].formatted_address;
                $(".city").text(place);
            });
            $(".temp").text(temp);
